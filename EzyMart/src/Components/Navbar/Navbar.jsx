...
const Navbar = () => {
  ...
  return (
    <div className='navbar'>
      <Link to='/' style={{ textDecoration: 'none', color: 'inherit' }} onClick={()=>{setMenu("shop")}} className="nav-logo" >
        <img src={logo} alt="" />
        <p>EzyMart</p> 
      </Link>
      ...
      <ul ref={menuRef} className="nav-menu">
        ...
        <li onClick={()=>{setMenu("womens")}}><Link to='/womens' style={{ textDecoration: 'none', color: 'inherit' }}>Women</Link>{menu==="womens"?<hr/>:<></>}</li>
